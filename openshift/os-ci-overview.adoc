...
Data Infrastructure Insights 사용을 시작하려면 다음 링크에서 가입하세요.link:https://www.netapp.com/forms/dii-free-trial/["Data Infrastructure Insights 무료 체험"] . 자세한 내용은 다음을 참조하십시오. link:https://docs.netapp.com/us-en/cloudinsights/task_cloud_insights_onboarding_1.html["Data Infrastructure Insights 온보딩"]
