...
정책 생성에 대한 자세한 내용은 다음을 참조하세요. https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-vmware-policy-create.html["데이터 저장소를 백업하기 위한 정책 생성"] .
...
자세한 내용은 다음을 참조하세요. https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-vmware-backup-aws.html["Amazon Web Services에 데이터 저장소 백업"] .
...
자세한 내용은 다음을 참조하세요. https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-vmware-restore.html["클라우드에서 가상 머신 데이터 복원"] .
