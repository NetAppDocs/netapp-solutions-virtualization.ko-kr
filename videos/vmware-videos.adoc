...
[role="lead"]
VMware와 NetApp 스토리지 솔루션의 통합을 보여주는 비디오 및 데모를 시청하세요. NetApp ONTAP Tools for VMware vSphere, SnapCenter Plug-in for VMware vSphere, 3-2-1 데이터 보호, 그리고 NetApp VMware Cloud Foundation 및 VMware vSphere Foundation과 연동되는 방식을 알아보세요.
